      ...
      <div className="px-6 md:px-16 lg:px-28 pb-12 md:pb-16">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
          ...
          <div>
            ...
            <p className="font-light text-base leading-6 md:leading-7 mb-4">
          ...
          {/* Links */}
          <div>
            <h4 className="font-semibold text-base mb-4">Links</h4>
            <ul className="space-y-3">
              <li>
                <Link href="/about" className="font-light text-base hover:text-blue-accent transition-colors">
                  About Us
                </Link>
              </li>
              <li>
                <Link href="/leadership" className="font-light text-base hover:text-blue-accent transition-colors">
                  Leadership
                </Link>
              </li>
              <li>
                <Link href="/transactions" className="font-light text-base hover:text-blue-accent transition-colors">
                  Transactions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <a
                  href="https://www.dextercapital.in/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-light text-base hover:text-blue-accent transition-colors"
                >
              ...
              <li>
                <a
                  href="https://www.dexter.ventures/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-light text-base hover:text-blue-accent transition-colors"
                >
              ...
              <li>
                <a
                  href="https://www.dexterfoundation.in/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="font-light text-base hover:text-blue-accent transition-colors"
                >
